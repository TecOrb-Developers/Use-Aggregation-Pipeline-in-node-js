...
var make_error_1 = __importDefault(require("make-error"));
...
function readJson(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, isExist(filePath)];
                case 1:
                    isFileExist = _a.sent();
                    return [2 /*return*/, isFileExist && require(filePath)];
            }
        });
    });
}
...
var TSError = /** @class */ (function (_super) {
    ...
    return TSError;
}(make_error_1["default"].BaseError));
